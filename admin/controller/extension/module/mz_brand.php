...
class ControllerExtensionModuleMzBrand extends Controller {
        ...
        public function index() {
                ...
                // Data
                $setting['brand_source']      =   'selected';
                $setting['selected_manufacturer']= array();
                ...
                // Feature brand
                $data['selected_manufacturers'] = array();
                        
                foreach ($setting['selected_manufacturer'] as $manufacturer_id) {
                ...
                $data['list_sort'] = array(
                    ...
                    array('id' => 'random', 'name' => $this->language->get('text_random')),
