...
class ControllerExtensionMzContentInformationDescription extends maza\layout\Content {
    public function index() {
        $this->load->language('extension/mz_content/information/description');
        ...
        $this->response->setOutput($this->load->view('extension/mz_content/information/description', $data));
    }
}
