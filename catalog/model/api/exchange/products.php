...
//***************************************************************************************************************************************************
    ...
    function addProductDescription($data){
        $this->db->query("INSERT INTO `" . DB_PREFIX . "product_description` (product_id, language_id, name, meta_title, description) 
        VALUES('$data->product_id', '$data->language_id', '$data->name', '$data->name', '$data->description')");

        $this->db->query("INSERT INTO `" . DB_PREFIX . "product_description` (product_id, language_id, name, meta_title, description) 
        VALUES('$data->product_id', '3', '$data->name', '$data->name', '$data->description_fr')");
    }
